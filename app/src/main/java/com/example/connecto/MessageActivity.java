...
import com.example.connecto.Adapters.MessageAdapter;
...
public class MessageActivity extends AppCompatActivity {
    ...
    public void chooseImage()
    {
        ...
        startActivityForResult(in,REQ_CODE_IMAGE_INPUT);
    }
    ...
    private void uploadImage(Intent data)
    {
        ...
        if(selectedImage!=null)
        {
            ...
            final StorageReference storageReference= FirebaseStorage.getInstance().getReference().child("message").child(userUid).child(randomString);
            ...
            storageReference.putFile(selectedImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                    storageReference.getDownloadUrl().addOnSuccessListener(MessageActivity.this,new OnSuccessListener<Uri>() {
                        @Override
                        public void onSuccess(Uri uri) {
                              Date date= new Date();
                              final MessageModel messageModel= new MessageModel(null,uri.toString(),date);
                              databaseReference.child(uid).child("message").child(userUid).child(randomString).setValue(messageModel).addOnCompleteListener(new OnCompleteListener<Void>() {
                                  @Override
...
import android.support.annotation.NonNull;recyclerView.setLayoutManager(new LinearLayoutManager(MessageActivity.this));
